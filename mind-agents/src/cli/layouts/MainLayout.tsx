...
export const MainLayout: React.FC<MainLayoutProps> = ({ command = 'dashboard' }) => {
  ...
  const renderHelp = () => (
    <Box flexDirection="column" padding={1} borderStyle="round" borderColor="blue">
      <Text bold color="blue">SYMindX CLI Help</Text>
      <Text> </Text>
  ...
  return (
    <Box flexDirection="column" height="100%">
      <Box padding={1} borderStyle="double" borderColor="cyan">
        <Text bold color="cyan">SYMindX Interactive CLI</Text>
        <Text color="gray"> | Current View: {currentView} | Press 'h' for help</Text>
      </Box>
