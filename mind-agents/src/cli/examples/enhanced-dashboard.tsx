        ...
        >
          <Box flexDirection="column" padding={1}>
            ...
            <Box flexDirection="column" marginTop={1}>
              {agents.filter(a => a.status !== 'inactive').map((agent, _i) => (
          ...
          <Box flexDirection="column" gap={1}>
            <Box>
              ...
              <PulsingEffect variant="glow">
                <Text color="green">{agents[selectedAgent]?.status ?? 'Unknown'}</Text>
              </PulsingEffect>
            </Box>
            
            <Box>
              <Text>Emotion: </Text>
              <Text color="cyan">{agents[selectedAgent]?.emotion ?? 'Unknown'}</Text>
            </Box>
            ...
            <Box>
              ...
              <AnimatedChart
                ...
                data={Array.from({ length: 10 }, () => ({ 
                  value: (agents[selectedAgent]?.activity ?? 0) + Math.random() * 20 - 10 
                }))}
                width={20}
              />
            </Box>
